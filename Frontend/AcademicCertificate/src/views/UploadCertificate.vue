  ...
  <div>
    ...
    <div class="container">
      ...
      <form @submit.prevent="submitForm" class="upload-form">
        ...
        <div class="form-group">
          <label for="institution_address">Endereço Ethereum da Instituição</label>
          <input type="text" id="institution_address" v-model="institutionAddress" placeholder="Endereço Ethereum" required />
        </div>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append('institution_address', this.institutionAddress);
